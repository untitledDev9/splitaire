  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      <nav className="w-64 bg-white border-r p-6">
        ...
        <nav className="space-y-4 text-gray-700">
          ...
          <a
            ...
            className="flex items-center gap-2 hover:text-emerald-600 transition"
          >
            <PlusCircle className="w-5 h-5" /> Create Bill
          </a>
          <a
            href="/history"
            className="flex items-center gap-2 hover:text-emerald-600 transition"
      ...
      <main className="flex-1 p-10">
          ...
          <div>
            ...
            <div className="flex flex-col items-start space-y-4">
              <div className="flex flex-col items-center">
                ...
                <button className="mt-3 flex items-center gap-2 font-semibold px-6 py-3 rounded-lg text-sm font-medium text-white bg-emerald-600 border hover:underline">
        ...
        <div className="mb-10">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center border border-gray-300 rounded-lg p-3">
              <p>Visa ending in 4242 <br/> • Expires 12/25</p>
              <button className="text-sm text-red-500 hover:underline">
                Remove
              </button>
            </div>
            <div className="flex justify-between items-center border border-gray-300 rounded-lg p-3">
              <p>Mastercard ending in 8888 <br/> • Expires 7/25</p>
              <button className="text-sm text-red-500 hover:underline">
                Remove
              </button>
            </div>
        ...
        <button 
         onClick={() => navigate("/")}
            type="button" className="bg-emerald-600 text-white px-6 py-3 rounded-lg hover:bg-emerald-800 flex items-center gap-2">
