      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            This is a temporary view of the bill. You can check details, mark
            your share as paid, or add comments.
          </p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden mb-8">
          ...
          <div className="divide-y divide-gray-100">
            {participants.map((participant) => (
              <div
                key={participant.id}
                className="px-6 md:px-8 py-5 hover:bg-gray-50 transition-colors"
              >
                <div className="flex items-center justify-between">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <div className="divide-y divide-gray-100">
            {comments.map((cmt) => (
              <div
                key={cmt.id}
                className="px-6 md:px-8 py-6 hover:bg-gray-50 transition-colors"
              >
                <div className="flex space-x-3">
